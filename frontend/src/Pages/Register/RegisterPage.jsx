          ...
          <div className=" h-auto w-full md:w-[50%] items-center justify-center flex gap-10 flex-col ">
            ...
            <div className=" mt-2 md:mt-10 flex w-full items-center justify-evenly ">
              <button
                ...
                className=" text-sm md:text-lg text-teal-300 underline underline-offset-3 hover:text-teal-50 transition duration-700 "
              >
                Back to home?
              </button>
              <button
                onClick={() => handleNavigation("/login")}
                className=" text-sm md:text-lg text-teal-100 underline underline-offset-3 hover:text-gray-200 transition duration-700 "
              >
